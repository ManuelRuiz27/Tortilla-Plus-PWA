...
4. Frontend llama POST /sales con carrito.
5. Backend responde venta draft con total.
6. Frontend llama POST /sales/{id}/complete con pagos.
7. Backend completa venta y descuenta inventario.
8. Frontend limpia carrito.
9. Frontend muestra SaleSuccessModal.
```
