...
```txt
[ ] Crear venta draft desde carrito
...
GET /cash-movements?branchId=&status=
...
```txt
/docs/ui-ux/01-uiux-design-handoff.md
/docs/ui-ux/02-uiux-screen-specification.md
/docs/ui-ux/03-uiux-wireframe-checklist.md
```
